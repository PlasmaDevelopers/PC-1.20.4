...
/* 843 */     Objects.requireNonNull(RealmsMainScreen.access$1300(paramRealmsMainScreen)); this.textFrame = (FrameLayout)this.gridLayout.addChild((LayoutElement)new FrameLayout(0, 9 * 3 * ($$1 - 1)), 0, 1, this.gridLayout.newCellSettings().paddingTop(7));
/* 844 */     this.textWidget = (MultiLineTextWidget)this.textFrame.addChild((LayoutElement)(new MultiLineTextWidget($$0, RealmsMainScreen.access$1400(paramRealmsMainScreen))).setCentered(true), this.textFrame.newChildLayoutSettings().alignHorizontallyCenter().alignVerticallyTop());
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\com\mojang\realmsclient\RealmsMainScreen$NotificationMessageEntry.class
