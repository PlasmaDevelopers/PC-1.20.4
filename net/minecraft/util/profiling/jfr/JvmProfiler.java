...
/*    */ {
/* 19 */   public static final JvmProfiler INSTANCE = Runtime.class.getModule().getLayer().findModule("jdk.jfr").isPresent() ? JfrProfiler.getInstance() : new NoOpProfiler();
/*    */   
...
/*    */   
/*    */   void onPacketReceived(ConnectionProtocol paramConnectionProtocol, int paramInt1, SocketAddress paramSocketAddress, int paramInt2);
/*    */   
/*    */   void onPacketSent(ConnectionProtocol paramConnectionProtocol, int paramInt1, SocketAddress paramSocketAddress, int paramInt2);
/*    */   
/*    */   @Nullable
