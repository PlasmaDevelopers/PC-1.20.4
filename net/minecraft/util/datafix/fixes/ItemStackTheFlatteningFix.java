...
/*     */   static {
/*  29 */     MAP = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), $$0 -> {
...
/*     */         });
/* 353 */     IDS = (Set<String>)MAP.keySet().stream().map($$0 -> $$0.substring(0, $$0.indexOf('.'))).collect(Collectors.toSet());
/*     */   }
...
/* 412 */     Type<?> $$0 = getInputSchema().getType(References.ITEM_STACK);
/*     */     
/* 414 */     OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
/* 415 */     OpticFinder<?> $$2 = $$0.findField("tag");
/*     */     
/* 417 */     return fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", $$0, $$2 -> {
...
/*     */           if ($$7 != null) {
/*     */             $$4 = $$4.set($$0, Pair.of(References.ITEM_NAME.typeName(), $$7));
/*     */           }
/*     */           if (DAMAGE_IDS.contains(((Pair)$$3.get()).getSecond())) {
/*     */             Typed<?> $$8 = $$2.getOrCreateTyped($$1);
/*     */             Dynamic<?> $$9 = (Dynamic)$$8.get(DSL.remainderFinder());
/*     */             $$9 = $$9.set("Damage", $$9.createInt($$6));
/*     */             $$4 = $$4.set($$1, $$8.set(DSL.remainderFinder(), $$9));
/*     */           } 
...
/* 446 */     if (IDS.contains($$0)) {
/* 447 */       String $$2 = MAP.get($$0 + "." + $$0);
/* 448 */       return ($$2 == null) ? MAP.get($$0 + ".0") : $$2;
/*     */     } 
/* 450 */     return null;
/*     */   }
/*     */ }
