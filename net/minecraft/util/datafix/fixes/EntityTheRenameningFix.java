...
/* 52 */     super("EntityTheRenameningBlock", $$0, $$1);
/*    */   }
/*    */ 
/*    */ 
/*    */   
/*    */   protected String rename(String $$0) {
/* 58 */     if ($$0.startsWith("minecraft:bred_")) {
/* 59 */       $$0 = "minecraft:" + $$0.substring("minecraft:bred_".length());
/*    */     }
/* 61 */     return RENAMED_IDS.getOrDefault($$0, $$0);
/*    */   }
/*    */ }
