...
/*     */   }
/*     */   static {
/*  25 */     ITEM_NAMES = (Int2ObjectMap<String>)DataFixUtils.make(new Int2ObjectOpenHashMap(), $$0 -> {
...
/* 345 */     return (String)ITEM_NAMES.get($$0);
/*     */   }
/*     */ 
/*     */   
/*     */   public TypeRewriteRule makeRule() {
/* 350 */     Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
/* 351 */     Type<Pair<String, String>> $$1 = DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
/* 352 */     OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
/* 353 */     return fixTypeEverywhereTyped("ItemIdFix", getInputSchema().getType(References.ITEM_STACK), getOutputSchema().getType(References.ITEM_STACK), $$2 -> $$2.update($$0, $$1, ()));
/*     */   }
/*     */ }
