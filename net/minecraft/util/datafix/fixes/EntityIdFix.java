...
/*     */   static {
/*  18 */     ID_MAP = (Map<String, String>)DataFixUtils.make(Maps.newHashMap(), $$0 -> {
...
/*  98 */     TaggedChoice.TaggedChoiceType<String> $$0 = getInputSchema().findChoiceType(References.ENTITY);
/*  99 */     TaggedChoice.TaggedChoiceType<String> $$1 = getOutputSchema().findChoiceType(References.ENTITY);
/*     */     
/* 101 */     Type<?> $$2 = getInputSchema().getType(References.ITEM_STACK);
/* 102 */     Type<?> $$3 = getOutputSchema().getType(References.ITEM_STACK);
/*     */     
/* 104 */     return TypeRewriteRule.seq(
/* 105 */         convertUnchecked("item stack entity name hook converter", $$2, $$3), 
/* 106 */         fixTypeEverywhere("EntityIdFix", (Type)$$0, (Type)$$1, $$0 -> ()));
/*     */   }
/*     */ }
