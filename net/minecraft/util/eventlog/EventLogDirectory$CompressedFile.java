...
/*     */   }
/*     */   
/*     */   public CompressedFile(Path $$0, EventLogDirectory.FileId $$1) {
/* 207 */     this.path = $$0; this.id = $$1; } public Path path() { return this.path; } public EventLogDirectory.FileId id() { return this.id; }
/*     */   
/*     */   @Nullable
...
/* 212 */       return null;
/*     */     }
/* 214 */     return new BufferedReader(new InputStreamReader(new GZIPInputStream(Files.newInputStream(this.path, new java.nio.file.OpenOption[0]))));
/*     */   }
/*     */ 
/*     */   
