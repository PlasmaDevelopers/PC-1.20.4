...
/*     */   }
/*     */   
/*     */   ValueAndHolder(RegistrySetBuilder.RegisteredValue<T> $$0, Optional<Holder.Reference<T>> $$1) {
/* 182 */     this.value = $$0; this.holder = $$1; } public RegistrySetBuilder.RegisteredValue<T> value() { return this.value; } public Optional<Holder.Reference<T>> holder() { return this.holder; }
/*     */ 
/*     */ }
