...
/*  22 */   static final Logger LOGGER = LogUtils.getLogger();
/*     */   
...
/*  30 */     this.onlineScreen = $$0;
/*     */   }
/*     */   
/*     */   public void connect(final RealmsServer server, ServerAddress $$1) {
/*  34 */     final Minecraft minecraft = Minecraft.getInstance();
/*  35 */     $$2.prepareForMultiplayer();
/*  36 */     $$2.getNarrator().sayNow((Component)Component.translatable("mco.connect.success"));
/*     */     
/*  38 */     final String hostname = $$1.getHost();
/*  39 */     final int port = $$1.getPort();
/*  40 */     (new Thread("Realms-connect-task")
/*     */       {
/*     */         public void run() {
...
/*     */   
/*     */   public void abort() {
/*  99 */     this.aborted = true;
/*     */     
/* 101 */     if (this.connection != null && 
/* 102 */       this.connection.isConnected()) {
/* 103 */       this.connection.disconnect((Component)Component.translatable("disconnect.genericReason"));
/* 104 */       this.connection.handleDisconnection();
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 111 */       if (this.connection.isConnected()) {
/* 112 */         this.connection.tick();
/*     */       } else {
/* 114 */         this.connection.handleDisconnection();
/*     */       }  
/*     */   }
/*     */ }
