...
/*    */   }
/*    */   
/*    */   public static Criterion<TriggerInstance> unlocked(ResourceLocation $$0) {
/* 25 */     return CriteriaTriggers.RECIPE_UNLOCKED.createCriterion(new TriggerInstance(Optional.empty(), $$0));
/*    */   }
/*    */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final ResourceLocation recipe; public static final Codec<TriggerInstance> CODEC;
/* 28 */     public TriggerInstance(Optional<ContextAwarePredicate> $$0, ResourceLocation $$1) { this.player = $$0; this.recipe = $$1; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 28 */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/RecipeUnlockedTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/RecipeUnlockedTrigger$TriggerInstance; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 28 */       //   0	8	1	$$0	Ljava/lang/Object; } public ResourceLocation recipe() { return this.recipe; }
/*    */ 
/*    */     
/*    */     static {
