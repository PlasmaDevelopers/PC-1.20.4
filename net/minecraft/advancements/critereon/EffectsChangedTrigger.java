...
/* 22 */     LootContext $$2 = ($$1 != null) ? EntityPredicate.createContext($$0, $$1) : null;
...
/* 26 */     public TriggerInstance(Optional<ContextAwarePredicate> $$0, Optional<MobEffectsPredicate> $$1, Optional<ContextAwarePredicate> $$2) { this.player = $$0; this.effects = $$1; this.source = $$2; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 26 */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/EffectsChangedTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/EffectsChangedTrigger$TriggerInstance; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
