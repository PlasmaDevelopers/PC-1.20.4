...
/* 23 */     LootContext $$4 = EntityPredicate.createContext($$0, (Entity)$$2);
/*    */     
/* 25 */     trigger($$0, $$2 -> $$2.matches($$0, $$1));
/*    */   }
/*    */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final Optional<ContextAwarePredicate> zombie; private final Optional<ContextAwarePredicate> villager; public static final Codec<TriggerInstance> CODEC;
/* 28 */     public TriggerInstance(Optional<ContextAwarePredicate> $$0, Optional<ContextAwarePredicate> $$1, Optional<ContextAwarePredicate> $$2) { this.player = $$0; this.zombie = $$1; this.villager = $$2; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 28 */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/CuredZombieVillagerTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/CuredZombieVillagerTrigger$TriggerInstance; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 28 */       //   0	8	1	$$0	Ljava/lang/Object; } public Optional<ContextAwarePredicate> zombie() { return this.zombie; } public Optional<ContextAwarePredicate> villager() { return this.villager; }
/*    */ 
/*    */ 
/*    */     
/*    */     static {
