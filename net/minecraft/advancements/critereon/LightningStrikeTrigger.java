...
/* 24 */     List<LootContext> $$3 = (List<LootContext>)$$2.stream().map($$1 -> EntityPredicate.createContext($$0, $$1)).collect(Collectors.toList());
/* 25 */     LootContext $$4 = EntityPredicate.createContext($$0, (Entity)$$1);
/* 26 */     trigger($$0, $$2 -> $$2.matches($$0, $$1));
/*    */   }
...
/* 29 */     public TriggerInstance(Optional<ContextAwarePredicate> $$0, Optional<ContextAwarePredicate> $$1, Optional<ContextAwarePredicate> $$2) { this.player = $$0; this.lightning = $$1; this.bystander = $$2; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 29 */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/LightningStrikeTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/LightningStrikeTrigger$TriggerInstance; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/* 29 */       //   0	8	1	$$0	Ljava/lang/Object; } public Optional<ContextAwarePredicate> lightning() { return this.lightning; } public Optional<ContextAwarePredicate> bystander() { return this.bystander; }
/*    */ 
/*    */ 
/*    */     
/*    */     static {
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\advancements\critereon\LightningStrikeTrigger.class
