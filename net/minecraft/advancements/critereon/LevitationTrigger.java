...
/* 20 */     trigger($$0, $$3 -> $$3.matches($$0, $$1, $$2));
/*    */   }
/*    */   public static final class TriggerInstance extends Record implements SimpleCriterionTrigger.SimpleInstance { private final Optional<ContextAwarePredicate> player; private final Optional<DistancePredicate> distance; private final MinMaxBounds.Ints duration; public static final Codec<TriggerInstance> CODEC;
/* 23 */     public TriggerInstance(Optional<ContextAwarePredicate> $$0, Optional<DistancePredicate> $$1, MinMaxBounds.Ints $$2) { this.player = $$0; this.distance = $$1; this.duration = $$2; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 23 */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/LevitationTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/LevitationTrigger$TriggerInstance; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
