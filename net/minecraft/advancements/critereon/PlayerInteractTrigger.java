...
/* 22 */     LootContext $$3 = EntityPredicate.createContext($$0, $$2);
...
/* 26 */     public TriggerInstance(Optional<ContextAwarePredicate> $$0, Optional<ItemPredicate> $$1, Optional<ContextAwarePredicate> $$2) { this.player = $$0; this.item = $$1; this.entity = $$2; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/* 26 */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/PlayerInteractTrigger$TriggerInstance; } public Optional<ContextAwarePredicate> player() { return this.player; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable table:
/*    */       //   start	length	slot	name	descriptor
/*    */       //   0	7	0	this	Lnet/minecraft/advancements/critereon/PlayerInteractTrigger$TriggerInstance; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
