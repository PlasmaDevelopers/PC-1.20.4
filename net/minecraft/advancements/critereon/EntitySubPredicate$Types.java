...
/*    */ {
/* 42 */   public static final EntitySubPredicate.Type ANY = new EntitySubPredicate.Type(MapCodec.unit(new EntitySubPredicate()
/*    */         {
...
/* 55 */   public static final EntitySubPredicate.Type PLAYER = new EntitySubPredicate.Type((MapCodec)PlayerPredicate.CODEC); public static final EntityVariantPredicate<CatVariant> CAT; public static final EntityVariantPredicate<FrogVariant> FROG; public static final EntityVariantPredicate<Axolotl.Variant> AXOLOTL; public static final EntityVariantPredicate<Boat.Type> BOAT; public static final EntityVariantPredicate<Fox.Type> FOX; public static final EntityVariantPredicate<MushroomCow.MushroomType> MOOSHROOM; public static final EntityVariantPredicate<Holder<PaintingVariant>> PAINTING;
/* 56 */   public static final EntitySubPredicate.Type SLIME = new EntitySubPredicate.Type((MapCodec)SlimePredicate.CODEC); public static final EntityVariantPredicate<Rabbit.Variant> RABBIT; public static final EntityVariantPredicate<Variant> HORSE; public static final EntityVariantPredicate<Llama.Variant> LLAMA; public static final EntityVariantPredicate<VillagerType> VILLAGER; public static final EntityVariantPredicate<Parrot.Variant> PARROT; public static final EntityVariantPredicate<TropicalFish.Pattern> TROPICAL_FISH; static {
/* 57 */     CAT = EntityVariantPredicate.create(BuiltInRegistries.CAT_VARIANT, $$0 -> { Cat $$1 = (Cat)$$0; return (Function)(($$0 instanceof Cat) ? Optional.<CatVariant>of($$1.getVariant()) : Optional.empty());
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\advancements\critereon\EntitySubPredicate$Types.class
