...
/* 13 */   public static final FoodProperties BEETROOT_SOUP = stew(6).build();
...
/* 43 */   public static final FoodProperties MUSHROOM_STEW = stew(6).build();
...
/* 51 */     .effect(new MobEffectInstance(MobEffects.POISON, 1200, 1), 1.0F)
...
/* 57 */   public static final FoodProperties RABBIT_STEW = stew(10).build();
...
/* 64 */     .build();
/* 65 */   public static final FoodProperties SUSPICIOUS_STEW = stew(6).alwaysEat().build();
/* 66 */   public static final FoodProperties SWEET_BERRIES = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.1F).build();
/* 67 */   public static final FoodProperties GLOW_BERRIES = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.1F).build();
/* 68 */   public static final FoodProperties TROPICAL_FISH = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.1F).build();
/*    */   
/*    */   private static FoodProperties.Builder stew(int $$0) {
/* 71 */     return (new FoodProperties.Builder()).nutrition($$0).saturationMod(0.6F);
/*    */   }
/*    */ }
