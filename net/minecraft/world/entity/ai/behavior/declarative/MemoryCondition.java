...
/*    */     
/* 28 */     public Registered(MemoryModuleType<Value> $$0) { this.memory = $$0; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */     
/* 43 */     public Present(MemoryModuleType<Value> $$0) { this.memory = $$0; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/world/entity/ai/behavior/declarative/MemoryCondition$Present<TValue;>; } public final int hashCode() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/world/entity/ai/behavior/declarative/MemoryCondition$Present<TValue;>; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/* 43 */       //   0	8	0	this	Lnet/minecraft/world/entity/ai/behavior/declarative/MemoryCondition$Present<TValue;>; } public MemoryModuleType<Value> memory() { return this.memory; }
/*    */     
...
/*    */     
/* 60 */     public Absent(MemoryModuleType<Value> $$0) { this.memory = $$0; } public final String toString() { // Byte code:
/*    */       //   0: aload_0
...
/*    */       // Local variable type table:
/*    */       //   start	length	slot	name	signature
/*    */       //   0	7	0	this	Lnet/minecraft/world/entity/ai/behavior/declarative/MemoryCondition$Absent<TValue;>; } public final boolean equals(Object $$0) { // Byte code:
/*    */       //   0: aload_0
/*    */       //   1: aload_1
