...
/*  24 */   public final Int2IntMap contents = (Int2IntMap)new Int2IntOpenHashMap(); private static final int EMPTY = 0;
/*     */   
/*     */   public void accountSimpleStack(ItemStack $$0) {
/*  27 */     if (!$$0.isDamaged() && !$$0.isEnchanted() && !$$0.hasCustomHoverName()) {
/*  28 */       accountStack($$0);
/*     */     }
/*     */   }
/*     */   
/*     */   public void accountStack(ItemStack $$0) {
/*  33 */     accountStack($$0, 64);
/*     */   }
/*     */   
/*     */   public void accountStack(ItemStack $$0, int $$1) {
/*  37 */     if (!$$0.isEmpty()) {
/*  38 */       int $$2 = getStackingIndex($$0);
/*  39 */       int $$3 = Math.min($$1, $$0.getCount());
/*  40 */       put($$2, $$3);
/*     */     } 
/*     */   }
/*     */   
/*     */   public static int getStackingIndex(ItemStack $$0) {
/*  45 */     return BuiltInRegistries.ITEM.getId($$0.getItem());
/*     */   }
/*     */   
/*     */   boolean has(int $$0) {
/*  49 */     return (this.contents.get($$0) > 0);
/*     */   }
/*     */   
/*     */   int take(int $$0, int $$1) {
/*  53 */     int $$2 = this.contents.get($$0);
/*  54 */     if ($$2 >= $$1) {
/*  55 */       this.contents.put($$0, $$2 - $$1);
/*  56 */       return $$0;
/*     */     } 
/*     */     
/*  59 */     return 0;
...
/*  63 */     this.contents.put($$0, this.contents.get($$0) + $$1);
/*     */   }
/*     */   
/*     */   public boolean canCraft(Recipe<?> $$0, @Nullable IntList $$1) {
/*  67 */     return canCraft($$0, $$1, 1);
/*     */   }
/*     */   
/*     */   public boolean canCraft(Recipe<?> $$0, @Nullable IntList $$1, int $$2) {
/*  71 */     return (new RecipePicker($$0)).tryPick($$2, $$1);
/*     */   }
/*     */   
/*     */   public int getBiggestCraftableStack(RecipeHolder<?> $$0, @Nullable IntList $$1) {
/*  75 */     return getBiggestCraftableStack($$0, 2147483647, $$1);
/*     */   }
/*     */   
/*     */   public int getBiggestCraftableStack(RecipeHolder<?> $$0, int $$1, @Nullable IntList $$2) {
/*  79 */     return (new RecipePicker($$0.value())).tryPickAll($$1, $$2);
/*     */   }
/*     */   
...
/*     */     }
/*  86 */     return new ItemStack((ItemLike)Item.byId($$0));
/*     */   }
/*     */   
/*     */   public void clear() {
