...
/* 20 */     $$0.playSound(null, $$1.getX(), $$1.getY(), $$1.getZ(), SoundEvents.EGG_THROW, SoundSource.PLAYERS, 0.5F, 0.4F / ($$0.getRandom().nextFloat() * 0.4F + 0.8F));
/* 21 */     if (!$$0.isClientSide) {
/* 22 */       ThrownEgg $$4 = new ThrownEgg($$0, (LivingEntity)$$1);
/* 23 */       $$4.setItem($$3);
