...
/*     */   }
/*     */   
/*     */   protected Mapped(Type $$0, DensityFunction $$1, double $$2, double $$3) {
/* 896 */     this.type = $$0; this.input = $$1; this.minValue = $$2; this.maxValue = $$3; } public Type type() { return this.type; } public DensityFunction input() { return this.input; } public double minValue() { return this.minValue; } public double maxValue() { return this.maxValue; }
...
/* 933 */     switch (DensityFunctions.null.$SwitchMap$net$minecraft$world$level$levelgen$DensityFunctions$Mapped$Type[$$0.ordinal()]) { default: throw new IncompatibleClassChangeError();case 1: case 2: case 3: case 4: return 
/*     */ 
/*     */ 
/*     */           
/* 937 */           ($$1 > 0.0D) ? $$1 : ($$1 * 0.5D);
/* 938 */       case 5: return ($$1 > 0.0D) ? $$1 : ($$1 * 0.25D);
/*     */       case 6:
/*     */         break; }
/* 941 */      double $$2 = Mth.clamp($$1, -1.0D, 1.0D);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
