...
/*    */   }
/*    */   
/* 32 */   public Context(ChunkGenerator $$0, BiomeSource $$1, RandomState $$2, long $$3, ChunkPos $$4, C $$5, LevelHeightAccessor $$6, Predicate<Holder<Biome>> $$7, StructureTemplateManager $$8, RegistryAccess $$9) { this.chunkGenerator = $$0; this.biomeSource = $$1; this.randomState = $$2; this.seed = $$3; this.chunkPos = $$4; this.config = $$5; this.heightAccessor = $$6; this.validBiome = $$7; this.structureTemplateManager = $$8; this.registryAccess = $$9; } public ChunkGenerator chunkGenerator() { return this.chunkGenerator; } public final boolean equals(Object $$0) { // Byte code:
/*    */     //   0: aload_0
/*    */     //   1: aload_1
