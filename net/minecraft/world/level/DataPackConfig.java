...
/*    */   static {
/* 13 */     CODEC = RecordCodecBuilder.create($$0 -> $$0.group((App)Codec.STRING.listOf().fieldOf("Enabled").forGetter(()), (App)Codec.STRING.listOf().fieldOf("Disabled").forGetter(())).apply((Applicative)$$0, DataPackConfig::new));
/*    */   }
/*    */ 
/*    */   
...
/* 22 */     this.enabled = (List<String>)ImmutableList.copyOf($$0);
/* 23 */     this.disabled = (List<String>)ImmutableList.copyOf($$1);
/*    */   }
/*    */   
