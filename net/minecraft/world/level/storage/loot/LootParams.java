...
/*  40 */     return this.params.containsKey($$0);
/*     */   }
/*     */   
/*     */   public <T> T getParameter(LootContextParam<T> $$0) {
/*  44 */     T $$1 = (T)this.params.get($$0);
/*  45 */     if ($$1 == null) {
/*  46 */       throw new NoSuchElementException($$0.getName().toString());
/*     */     }
/*     */     
/*  49 */     return $$1;
/*     */   }
...
/*  77 */   public static class Builder { private final Map<LootContextParam<?>, Object> params = Maps.newIdentityHashMap(); private final ServerLevel level;
