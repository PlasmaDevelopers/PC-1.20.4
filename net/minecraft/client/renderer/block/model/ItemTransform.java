...
/*     */ {
/*  19 */   public static final ItemTransform NO_TRANSFORM = new ItemTransform(new Vector3f(), new Vector3f(), new Vector3f(1.0F, 1.0F, 1.0F));
/*     */   
...
/*  26 */     this.rotation = new Vector3f((Vector3fc)$$0);
/*  27 */     this.translation = new Vector3f((Vector3fc)$$1);
/*  28 */     this.scale = new Vector3f((Vector3fc)$$2);
/*     */   }
/*     */   
/*     */   public void apply(boolean $$0, PoseStack $$1) {
/*  32 */     if (this == NO_TRANSFORM) {
/*     */       return;
/*     */     }
/*  35 */     float $$2 = this.rotation.x();
/*  36 */     float $$3 = this.rotation.y();
/*  37 */     float $$4 = this.rotation.z();
/*     */     
/*  39 */     if ($$0) {
/*  40 */       $$3 = -$$3;
/*  41 */       $$4 = -$$4;
...
/*     */     
/*  44 */     int $$5 = $$0 ? -1 : 1;
/*  45 */     $$1.translate($$5 * this.translation.x(), this.translation.y(), this.translation.z());
/*  46 */     $$1.mulPose((new Quaternionf()).rotationXYZ($$2 * 0.017453292F, $$3 * 0.017453292F, $$4 * 0.017453292F));
/*  47 */     $$1.scale(this.scale.x(), this.scale.y(), this.scale.z());
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/*  56 */     if (getClass() == $$0.getClass()) {
/*  57 */       ItemTransform $$1 = (ItemTransform)$$0;
/*     */       
/*  59 */       return (this.rotation.equals($$1.rotation) && this.scale.equals($$1.scale) && this.translation.equals($$1.translation));
/*     */     } 
/*     */     
/*  62 */     return false;
/*     */   }
...
/*     */   
/*     */   public int hashCode() {
/*  67 */     int $$0 = this.rotation.hashCode();
/*  68 */     $$0 = 31 * $$0 + this.translation.hashCode();
/*  69 */     $$0 = 31 * $$0 + this.scale.hashCode();
/*  70 */     return $$0;
/*     */   }
/*     */   
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\client\renderer\block\model\ItemTransform.class
