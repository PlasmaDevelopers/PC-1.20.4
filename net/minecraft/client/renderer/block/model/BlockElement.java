...
/*  43 */     for (Map.Entry<Direction, BlockElementFace> $$0 : this.faces.entrySet()) {
/*  44 */       float[] $$1 = uvsByFace($$0.getKey());
/*  45 */       ((BlockElementFace)$$0.getValue()).uv.setMissingUv($$1);
/*     */     } 
/*     */   }
/*     */   
...
/*  50 */     switch ($$0)
/*     */     { case DOWN:
/*  52 */         return new float[] { this.from.x(), 16.0F - this.to.z(), this.to.x(), 16.0F - this.from.z() };
/*     */       case UP:
/*  54 */         return new float[] { this.from.x(), this.from.z(), this.to.x(), this.to.z() };
/*     */       
/*     */       default:
/*  57 */         return new float[] { 16.0F - this.to.x(), 16.0F - this.to.y(), 16.0F - this.from.x(), 16.0F - this.from.y() };
/*     */       case SOUTH:
/*  59 */         return new float[] { this.from.x(), 16.0F - this.to.y(), this.to.x(), 16.0F - this.from.y() };
/*     */       case WEST:
/*  61 */         return new float[] { this.from.z(), 16.0F - this.to.y(), this.to.z(), 16.0F - this.from.y() };
/*     */       case EAST:
/*  63 */         break; }  return new float[] { 16.0F - this.to.z(), 16.0F - this.to.y(), 16.0F - this.from.z(), 16.0F - this.from.y() };
/*     */   }
/*     */   
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\client\renderer\block\model\BlockElement.class
