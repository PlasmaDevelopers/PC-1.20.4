...
/*     */     //   0	7	0	this	Lnet/minecraft/client/gui/font/providers/BitmapProvider$Definition;
/*     */   }
/*     */   
...
/*  57 */     this.file = $$0; this.height = $$1; this.ascent = $$2; this.codepointGrid = $$3; } public final boolean equals(Object $$0) { // Byte code:
/*     */     //   0: aload_0
/*     */     //   1: aload_1
...
/*  57 */     //   0	8	1	$$0	Ljava/lang/Object; } public ResourceLocation file() { return this.file; } public int height() { return this.height; } public int ascent() { return this.ascent; } public int[][] codepointGrid() { return this.codepointGrid; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */       return DataResult.error(() -> "Expected to find data in codepoint grid");  for (int $$4 = 1; $$4 < $$1; $$4++) { int[] $$5 = $$0[$$4]; if ($$5.length != $$3)
/*     */         return DataResult.error(() -> "Lines in codepoint grid have to be the same length (found: " + $$0.length + " codepoints, expected: " + $$1 + "), pad with \\u0000");  }
/* 122 */      return DataResult.success($$0); } public GlyphProviderType type() { return GlyphProviderType.BITMAP; }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\client\gui\font\providers\BitmapProvider$Definition.class
