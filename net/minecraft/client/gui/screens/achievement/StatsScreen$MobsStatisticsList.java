...
/*     */   extends ObjectSelectionList<StatsScreen.MobsStatisticsList.MobRow>
/*     */ {
/*     */   public MobsStatisticsList(Minecraft $$0) {
/* 452 */     super($$0, paramStatsScreen.width, paramStatsScreen.height - 96, 32, 9 * 4);
/*     */     
/* 454 */     for (EntityType<?> $$1 : (Iterable<EntityType<?>>)BuiltInRegistries.ENTITY_TYPE) {
/* 455 */       if (paramStatsScreen.stats.getValue(Stats.ENTITY_KILLED.get($$1)) > 0 || paramStatsScreen.stats.getValue(Stats.ENTITY_KILLED_BY.get($$1)) > 0)
...
/*     */       
/* 471 */       int $$1 = this$0.this$0.stats.getValue(Stats.ENTITY_KILLED.get($$0));
/* 472 */       if ($$1 == 0) {
...
/*     */       } 
/*     */       
/* 480 */       int $$2 = this$0.this$0.stats.getValue(Stats.ENTITY_KILLED_BY.get($$0));
/* 481 */       if ($$2 == 0) {
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\client\gui\screens\achievement\StatsScreen$MobsStatisticsList.class
