...
/*  20 */   static final ResourceLocation SELECT_HIGHLIGHTED_SPRITE = new ResourceLocation("transferable_list/select_highlighted");
/*  21 */   static final ResourceLocation SELECT_SPRITE = new ResourceLocation("transferable_list/select");
/*  22 */   static final ResourceLocation UNSELECT_HIGHLIGHTED_SPRITE = new ResourceLocation("transferable_list/unselect_highlighted");
/*  23 */   static final ResourceLocation UNSELECT_SPRITE = new ResourceLocation("transferable_list/unselect");
/*  24 */   static final ResourceLocation MOVE_UP_HIGHLIGHTED_SPRITE = new ResourceLocation("transferable_list/move_up_highlighted");
/*  25 */   static final ResourceLocation MOVE_UP_SPRITE = new ResourceLocation("transferable_list/move_up");
/*  26 */   static final ResourceLocation MOVE_DOWN_HIGHLIGHTED_SPRITE = new ResourceLocation("transferable_list/move_down_highlighted");
/*  27 */   static final ResourceLocation MOVE_DOWN_SPRITE = new ResourceLocation("transferable_list/move_down");
/*  28 */   static final Component INCOMPATIBLE_TITLE = (Component)Component.translatable("pack.incompatible");
/*  29 */   static final Component INCOMPATIBLE_CONFIRM_TITLE = (Component)Component.translatable("pack.incompatible.confirm.title");
/*     */   
...
/*  35 */     super($$0, $$2, $$3 - 83, 32, 36);
/*  36 */     this.screen = $$1;
/*  37 */     this.title = $$4;
/*  38 */     this.centerListVertically = false;
/*     */     
/*  40 */     Objects.requireNonNull($$0.font); setRenderHeader(true, (int)(9.0F * 1.5F));
/*     */   }
/*     */ 
/*     */   
/*     */   protected void renderHeader(GuiGraphics $$0, int $$1, int $$2) {
/*  45 */     MutableComponent mutableComponent = Component.empty().append(this.title).withStyle(new ChatFormatting[] { ChatFormatting.UNDERLINE, ChatFormatting.BOLD });
/*  46 */     $$0.drawString(this.minecraft.font, (Component)mutableComponent, $$1 + this.width / 2 - this.minecraft.font.width((FormattedText)mutableComponent) / 2, Math.min(getY() + 3, $$2), 16777215, false);
/*     */   }
/*     */ 
/*     */   
...
/*     */         case 32:
/*     */         case 257:
/*  65 */           ((PackEntry)getSelected()).keyboardSelection();
/*  66 */           return true;
/*     */       } 
/*     */       
/*  69 */       if (Screen.hasShiftDown()) {
/*  70 */         switch ($$0) {
/*     */           case 265:
/*  72 */             ((PackEntry)getSelected()).keyboardMoveUp();
/*  73 */             return true;
/*     */           
/*     */           case 264:
/*  76 */             ((PackEntry)getSelected()).keyboardMoveDown();
/*  77 */             return true;
/*     */         } 
/*     */       
/*     */       }
/*     */     } 
/*  82 */     return super.keyPressed($$0, $$1, $$2);
/*     */   }
/*     */ 
/*     */   
...
/* 235 */       double $$4 = $$1 - this.parent.getRowTop(this.parent.children().indexOf(this));
/*     */       
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\client\gui\screens\packs\TransferableSelectionList.class
