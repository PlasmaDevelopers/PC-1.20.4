...
/*  23 */   private static final ResourceLocation MAP_ICONS_LOCATION = new ResourceLocation("textures/map/map_icons.png");
/*  24 */   static final RenderType MAP_ICONS = RenderType.text(MAP_ICONS_LOCATION);
/*     */   
/*     */   private static final int WIDTH = 128;
/*     */   private static final int HEIGHT = 128;
/*     */   final TextureManager textureManager;
/*  29 */   private final Int2ObjectMap<MapInstance> maps = (Int2ObjectMap<MapInstance>)new Int2ObjectOpenHashMap();
/*     */   
/*     */   public MapRenderer(TextureManager $$0) {
/*  32 */     this.textureManager = $$0;
/*     */   }
/*     */   
/*     */   public void update(int $$0, MapItemSavedData $$1) {
/*  36 */     getOrCreateMapInstance($$0, $$1).forceUpload();
/*     */   }
/*     */   
/*     */   public void render(PoseStack $$0, MultiBufferSource $$1, int $$2, MapItemSavedData $$3, boolean $$4, int $$5) {
/*  40 */     getOrCreateMapInstance($$2, $$3).draw($$0, $$1, $$4, $$5);
/*     */   }
/*     */   
/*     */   private MapInstance getOrCreateMapInstance(int $$0, MapItemSavedData $$1) {
/*  44 */     return (MapInstance)this.maps.compute($$0, ($$1, $$2) -> {
/*     */           if ($$2 == null) {
/*     */             return new MapInstance($$1.intValue(), $$0);
/*     */           }
/*     */           $$2.replaceMapData($$0);
/*     */           return $$2;
/*     */         });
...
/*  56 */     for (ObjectIterator<MapInstance> objectIterator = this.maps.values().iterator(); objectIterator.hasNext(); ) { MapInstance $$0 = objectIterator.next();
/*  57 */       $$0.close(); }
/*     */ 
/*     */     
/*  60 */     this.maps.clear();
...
/*  77 */       ResourceLocation $$2 = MapRenderer.this.textureManager.register("map/" + $$0, this.texture);
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\client\gui\MapRenderer.class
