...
/* 167 */   public static final ResourceLeakDetector.Level NETTY_LEAK_DETECTION = ResourceLeakDetector.Level.DISABLED;
/*     */   
...
/* 179 */   public static final long MAXIMUM_TICK_TIME_NANOS = Duration.ofMillis(300L).toNanos();
/*     */   
...
/* 186 */   public static Set<DSL.TypeReference> DATA_FIX_TYPES_TO_OPTIMIZE = Set.of();
/*     */   
...
/*     */   }
/*     */   
/* 199 */   public static final char[] ILLEGAL_FILE_CHARACTERS = new char[] { '/', '\n', '\r', '\t', Character.MIN_VALUE, '\f', '`', '?', '*', '\\', '<', '>', '|', '"', ':' };
/*     */   
...
/* 215 */     return filterText($$0, false);
/*     */   }
/*     */   
/*     */   public static String filterText(String $$0, boolean $$1) {
/* 219 */     StringBuilder $$2 = new StringBuilder();
/*     */     
/* 221 */     for (char $$3 : $$0.toCharArray()) {
/* 222 */       if (isAllowedChatCharacter($$3)) {
/* 223 */         $$2.append($$3);
/* 224 */       } else if ($$1 && $$3 == '\n') {
/* 225 */         $$2.append($$3);
/*     */       } 
...
/* 236 */     if (CURRENT_VERSION == null) {
/* 237 */       CURRENT_VERSION = $$0;
/* 238 */     } else if ($$0 != CURRENT_VERSION) {
/* 239 */       throw new IllegalStateException("Cannot override the current game version!");
/*     */     } 
/*     */   }
/*     */   
/*     */   public static void tryDetectVersion() {
/* 244 */     if (CURRENT_VERSION == null) {
/* 245 */       CURRENT_VERSION = DetectedVersion.tryDetectVersion();
/*     */     }
/*     */   }
/*     */   
/*     */   public static WorldVersion getCurrentVersion() {
/* 250 */     if (CURRENT_VERSION == null) {
/* 251 */       throw new IllegalStateException("Game version not set");
/*     */     }
...
/*     */   
/*     */   static {
/* 264 */     ResourceLeakDetector.setLevel(NETTY_LEAK_DETECTION);
/* 265 */     CommandSyntaxException.ENABLE_COMMAND_STACK_TRACES = false;
/* 266 */     CommandSyntaxException.BUILT_IN_EXCEPTIONS = (BuiltInExceptionProvider)new BrigadierExceptions();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 273 */     int $$1 = $$0.getMinBlockX();
/* 274 */     int $$2 = $$0.getMinBlockZ();
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 279 */     if (debugGenerateSquareTerrainWithoutNoise) {
/* 280 */       return ($$1 > 8192 || $$1 < 0 || $$2 > 1024 || $$2 < 0);
/*     */     }
/* 282 */     return false;
/*     */   }
/*     */   
/*     */   public static void enableDataFixerOptimizations() {
/* 286 */     DATA_FIX_TYPES_TO_OPTIMIZE = DataFixTypes.TYPES_FOR_LEVEL_LIST;
/*     */   }
/*     */ }
