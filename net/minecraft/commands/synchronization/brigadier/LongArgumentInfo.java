...
/* 36 */     boolean $$2 = ($$0.min != Long.MIN_VALUE);
/* 37 */     boolean $$3 = ($$0.max != Long.MAX_VALUE);
/* 38 */     $$1.writeByte(ArgumentUtils.createNumberFlags($$2, $$3));
/* 39 */     if ($$2) {
/* 40 */       $$1.writeLong($$0.min);
/*    */     }
/* 42 */     if ($$3) {
/* 43 */       $$1.writeLong($$0.max);
/*    */     }
/*    */   }
/*    */ 
/*    */   
...
/* 50 */     long $$2 = ArgumentUtils.numberHasMin($$1) ? $$0.readLong() : Long.MIN_VALUE;
/* 51 */     long $$3 = ArgumentUtils.numberHasMax($$1) ? $$0.readLong() : Long.MAX_VALUE;
/* 52 */     return new Template($$2, $$3);
/*    */   }
/*    */ 
/*    */   
/*    */   public void serializeToJson(Template $$0, JsonObject $$1) {
/* 57 */     if ($$0.min != Long.MIN_VALUE) {
/* 58 */       $$1.addProperty("min", Long.valueOf($$0.min));
/*    */     }
/* 60 */     if ($$0.max != Long.MAX_VALUE) {
/* 61 */       $$1.addProperty("max", Long.valueOf($$0.max));
/*    */     }
/*    */   }
/*    */ 
/*    */   
