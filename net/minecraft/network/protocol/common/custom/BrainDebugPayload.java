...
/*     */   private final BrainDump brainDump;
/*     */   
/*  15 */   public BrainDebugPayload(BrainDump $$0) { this.brainDump = $$0; } public final String toString() { // Byte code:
/*     */     //   0: aload_0
/*     */     //   1: <illegal opcode> toString : (Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload;)Ljava/lang/String;
/*     */     //   6: areturn
/*     */     // Line number table:
...
/*     */     //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload; } public final int hashCode() { // Byte code:
/*     */     //   0: aload_0
/*     */     //   1: <illegal opcode> hashCode : (Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload;)I
/*     */     //   6: ireturn
/*     */     // Line number table:
/*     */     //   Java source line number -> byte code offset
/*     */     //   #15	-> 0
/*     */     // Local variable table:
/*     */     //   start	length	slot	name	descriptor
/*     */     //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload; } public final boolean equals(Object $$0) { // Byte code:
/*     */     //   0: aload_0
/*     */     //   1: aload_1
/*     */     //   2: <illegal opcode> equals : (Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload;Ljava/lang/Object;)Z
/*     */     //   7: ireturn
/*     */     // Line number table:
/*     */     //   Java source line number -> byte code offset
/*     */     //   #15	-> 0
/*     */     // Local variable table:
/*     */     //   start	length	slot	name	descriptor
/*     */     //   0	8	0	this	Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload;
/*  15 */     //   0	8	1	$$0	Ljava/lang/Object; } public BrainDump brainDump() { return this.brainDump; }
/*  16 */    public static final ResourceLocation ID = new ResourceLocation("debug/brain");
/*     */   
/*     */   public BrainDebugPayload(FriendlyByteBuf $$0) {
/*  19 */     this(new BrainDump($$0));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     private final UUID uuid; private final int id; private final String name; private final String profession; private final int xp; private final float health; private final float maxHealth; private final Vec3 pos; private final String inventory;
/*  34 */     public BrainDump(UUID $$0, int $$1, String $$2, String $$3, int $$4, float $$5, float $$6, Vec3 $$7, String $$8, @Nullable Path $$9, boolean $$10, int $$11, List<String> $$12, List<String> $$13, List<String> $$14, List<String> $$15, Set<BlockPos> $$16, Set<BlockPos> $$17) { this.uuid = $$0; this.id = $$1; this.name = $$2; this.profession = $$3; this.xp = $$4; this.health = $$5; this.maxHealth = $$6; this.pos = $$7; this.inventory = $$8; this.path = $$9; this.wantsGolem = $$10; this.angerLevel = $$11; this.activities = $$12; this.behaviors = $$13; this.memories = $$14; this.gossips = $$15; this.pois = $$16; this.potentialPois = $$17; } @Nullable private final Path path; private final boolean wantsGolem; private final int angerLevel; private final List<String> activities; private final List<String> behaviors; private final List<String> memories; private final List<String> gossips; private final Set<BlockPos> pois; private final Set<BlockPos> potentialPois; public final String toString() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload$BrainDump; } public final int hashCode() { // Byte code:
/*     */       //   0: aload_0
...
/*     */       // Local variable table:
/*     */       //   start	length	slot	name	descriptor
/*     */       //   0	7	0	this	Lnet/minecraft/network/protocol/common/custom/BrainDebugPayload$BrainDump; } public final boolean equals(Object $$0) { // Byte code:
/*     */       //   0: aload_0
/*     */       //   1: aload_1
...
/* Location:              C:\Users\Xiao\Downloads\output\client_deobfuscated.jar!\net\minecraft\network\protocol\common\custom\BrainDebugPayload.class
